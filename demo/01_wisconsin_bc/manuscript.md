...
**Conclusion:** All three machine learning classifiers demonstrated high diagnostic accuracy for FNA-based breast cancer classification, with AUC values exceeding 0.99. These results support the potential of automated cytological analysis as a computer-aided diagnostic tool in breast cancer screening.
...
Data are from the held-out test set (n = 114; 42 malignant, 72 benign). AUC 95% CIs from bootstrap resampling (2000 iterations). PPV = positive predictive value; NPV = negative predictive value.
