...
Week -6 (2026-03-20): Results draft → critic pass + /stats complete
Week -5 (2026-03-27): Discussion draft → critic pass
Week -4 (2026-04-03): Introduction + Abstract → critic pass
Week -3 (2026-04-10): /humanize pass + /checklist (reporting guideline)
...
Run /stats as soon as data is available.
```
