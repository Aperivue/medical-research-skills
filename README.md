...
| **Depth per skill** | 150-600 lines of documentation + bundled reference files (58 journal profiles, checklists, formula sheets, code templates) | Typically thin SKILL.md templates |
